...
-- Attack errors, synchronize with AB::GameProtocol::AttackError
ATTACK_ERROR_NONE = 0
ATTACK_ERROR_INVALID_TARGET = 1
ATTACK_ERROR_TARGET_UNDESTROYABLE = 2
ATTACK_ERROR_INTERRUPTED = 3
ATTACK_ERROR_NO_TARGET = 4
ATTACK_ERROR_TARGET_OBSTRUCTED = 5
ATTACK_ERROR_TARGET_DODGE = 6
ATTACK_ERROR_TARGET_MISSED = 7
ATTACK_ERROR_BLOCKED = 8
