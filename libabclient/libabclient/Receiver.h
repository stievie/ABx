...
public:
    ...
    virtual void OnPartyInvited(int64_t updateTick, uint32_t playerId) = 0;
    /// Player was removed from our party
    virtual void OnPartyRemoved(int64_t updateTick, uint32_t playerId) = 0;
    /// Player was added to our party, i.e. the player accepted the invite
    virtual void OnPartyAdded(int64_t updateTick, uint32_t playerId) = 0;
    /// The invite to our party was removed
    virtual void OnPartyInviteRemoved(int64_t updateTick, uint32_t playerId) = 0;
};
